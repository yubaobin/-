 ...
 */
    ...
    .constant('JQ_CONFIG', {
        ...
        umeditor: ['vendor/umeditor/themes/default/css/umeditor.css', 
        'vendor/umeditor/umeditor.config.js', 'vendor/umeditor/umeditor.js',
        'vendor/umeditor/plupload/plupload.full.min.js', 'vendor/umeditor/qiniu.js']
    }
)
    // oclazyload config  angularjs组件
            ...
            modules: [
                {
                    ...
                    name: 'bw.paging',
                    files: [
                        'vendor/modules/angular-paging/paging.js'
                    ]
                },
                {
                    name: 'ui.select',
                ...
                },
                {
                    name: 'ksSwiper',
                    files: [
                        'vendor/modules/angular-swiper/angular.swiper.js',
                        'vendor/modules/angular-swiper/swiper.js',
                        'vendor/modules/angular-swiper/swiper.min.css'
                    ]
                },
                {
